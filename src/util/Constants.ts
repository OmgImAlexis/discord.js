...
function makeImageUrl(root, { format = 'webp', size }: FIXME = {}) {
...
export const Endpoints = {
  CDN(root) {
    return {
      ...
      AppIcon: (clientID, hash, { format = 'webp', size }: FIXME = {}) =>
        makeImageUrl(`${root}/app-icons/${clientID}/${hash}`, { size, format }),
      AppAsset: (clientID, hash, { format = 'webp', size }: FIXME = {}) =>
      ...
      TeamIcon: (teamID, hash, { format = 'webp', size }: FIXME = {}) =>
